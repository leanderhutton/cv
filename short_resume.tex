...
\usepackage[left=1.0in,top=0.5in,right=1.0in,bottom=0.5in]{geometry} % Document margins
...
\item Provided second level support to end users.
\end{rSubsection}
...
\item Teaching introductory astronomy concepts to students; providing and evaluating hands-on exercises with laboratory equipment.
\end{rSubsection}
...
\item Installed and maintained Red Hat Enterprise Linux (RHEL) based systems.
\end{rSubsection}
...
\item Deployed and maintained a Mac and GNU/Linux servers, built system for assignment submission.
\end{rSubsection}
...
Programming Languages & C, Java, Python, PHP, X86 \& 8051 ASM \\
...
Watauga Amateur Radio Club & Member\\
