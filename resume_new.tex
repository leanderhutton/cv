...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://www.one-button.org}{\Large Leander Hutton}} & Email : \href{mailto:leander@one-button.org}{leander@one-button.org}\\
  \href{http://www.one-button.org}{http://www.one-button.org}
\end{tabular*}
...
\resumeSubHeadingListStart
    \resumeSubheading
      {Appalachian State University}{Bone, NC}
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      {Network Specialist}{Jan 2014 - Oct 2016}
      \resumeItemListStart
