...
Instrumentation and automation focus, astrophysics applications of GPGPU technology \\

{\bf Appalachian State University} \hfill {\em Degree Awarded - May 2008} \\ 
{\em Bachelor of Science in Physics \& Astronomy} \\
Investigation of binary asteroids \\
Findings published in ICARUS \\
...
\item Performed system administration tasks on GNU/Linux and BSD based systems.
...
\item Performed system administration tasks on GNU/Linux based systems.
\item Installed and maintained a variety of GNU/Linux application servers; including but not limited to nginx, Apache, MySQL, MailScanner, Sendmail, Postfix, Drupal, Aegir, Shibboleth, and Jenkins.
...
Programming Languages & C, Java, Python, Objective-C, PHP, X86 \& 8051 ASM, VB\\
Development and Version Control & Visual Studio, git, gitolite, gitosis, Xcode\\
Networking & ISC-DHCP, BIND DNS, OpenVPN, iptables, pf\\
...
Creative, Photo \& Video & Adobe CS, Lightroom, Capture One, Sony Vegas, Final Cut\\
\end{tabular}
