...
Networking & ISC-DHCP, BIND DNS, OpenVPN, iptables, nftables, pf\\
Email & postfix, dovecot, sendmail, amavis\\
Databases & MySQL, MariaDB, PostgreSQL, redis  \\
Network Storage & NFS, Samba CIFS, Netatalk \\
Data Storage & ZFS, BTRFS, Linux md\\
Web Servers & nginx, Apache\\
User Management \& SSO & Shibboleth, Cosign, LDAP\\
Content Management & Drupal, MediaWiki, Pelican\\
Virtualization & Xen, KVM, VirtualBox, VMWare, Vagrant \\
